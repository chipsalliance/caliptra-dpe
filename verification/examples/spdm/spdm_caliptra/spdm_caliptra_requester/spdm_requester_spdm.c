...
libspdm_return_t spdm_requester_device_receive_message(void *spdm_context,
...
void *spdm_client_init(void)
{
    ...
    libspdm_register_device_io_func(spdm_context, spdm_device_send_message,
                                    spdm_requester_device_receive_message);
    ...
    //         /* Do not free it.*/
    //         printf("\n1111AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    //     }
    //     else
    //     {
    //         printf("\n222AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    ...
    //     if (res)
    //     {
    //         printf("\n33333AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    //         libspdm_zero_mem(&parameter, sizeof(parameter));
    //         parameter.location = LIBSPDM_DATA_LOCATION_LOCAL;
    //         libspdm_set_data(spdm_context,
    //                          LIBSPDM_DATA_LOCAL_PUBLIC_KEY,
    //                          &parameter, data, data_size);
    //         printf("\n444444444AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    //         /* Do not free it.*/
    //     }
    //     else
    //     {
    //         printf("\n555555555AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    ...
    // else
    // {
    //     printf("\n66666666AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    ...
    //         /* Do not free it.*/
    //         printf("\n888888888888AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    //     }
    //     else
    //     {
    //         printf("\n9999999AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    ...
    //         /* Do not free it.*/
    //         printf("\n222222222BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB");
    //     }
    //     else
    //     {
    //         printf("\n33333333333BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB");
    //         printf("\nread_responder_root_public_certificate fail!\n");
    //         free(m_spdm_context);
    //         m_spdm_context = NULL;
    //         return NULL;
    ...
    //     else
    //     {
    //         printf("\n5555555555555BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB");
