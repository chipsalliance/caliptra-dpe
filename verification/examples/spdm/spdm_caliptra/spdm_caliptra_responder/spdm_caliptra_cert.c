...
bool caliptra_read_requester_root_public_certificate(uint32_t base_hash_algo,
                                                    ...
                                                    size_t *hash_size)
{
    printf("\nspdm_caliptra.c CHECKPOINT 111 INSIDE caliptra_read_requester_root_public_certificate()");
    bool res;
    void *file_data;
    size_t file_size;
...
{
    printf("\nspdm_caliptra.c CHECKPOINT 1 INSIDE caliptra_read_responder_public_certificate_chain()");
    bool res;
    void *file_data;
    size_t file_size;
    spdm_cert_chain_t *cert_chain;
    ...
    *size = 0;
    ...
    printf("\nspdm_caliptra.c CHECKPOINT 2 %d",base_asym_algo);
    ...
    void **data, size_t *size, void **hash, size_t *hash_size)
{
    ...
    *size = 0;
    ...
    if (slot_id == 0) {
        printf("\nspdm_caliptra.c CHECKPOINT 4 : SLOT ID = 0");
        switch (base_asym_algo) {
        case SPDM_ALGORITHMS_BASE_ASYM_ALGO_TPM_ALG_RSASSA_2048:
        case SPDM_ALGORITHMS_BASE_ASYM_ALGO_TPM_ALG_RSAPSS_2048:
            file = "rsa2048/bundle_responder.certchain.der";
        ...
        printf("\nspdm_caliptra.c CHECKPOINT 5 SLOT ID != 0 %d",slot_id);
        switch (base_asym_algo) {
        case SPDM_ALGORITHMS_BASE_ASYM_ALGO_TPM_ALG_RSASSA_2048:
        case SPDM_ALGORITHMS_BASE_ASYM_ALGO_TPM_ALG_RSAPSS_2048:
    ...
    void **data, size_t *size, void **hash, size_t *hash_size)
{
    ...
    *size = 0;
    ...
    case LIBSPDM_TEST_CERT_SMALL:
        ...
        break;
    case LIBSPDM_TEST_CERT_MAXINT16: 
        file = "long_chains/ShorterMAXINT16_ca.cert.der";
        break;
    case LIBSPDM_TEST_CERT_MAXUINT16:
        file = "long_chains/ShorterMAXUINT16_ca.cert.der";
        break;
    case LIBSPDM_LIBSPDM_TEST_CERT_MAXUINT16_LARGER:
