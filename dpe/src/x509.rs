...
impl CertWriter<'_> {
    ...
    const ID_SIGNED_DATA_OID: &'static [u8] = &[0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x07, 0x02];
    ...
    const EXTENSION_REQUEST_OID: &'static [u8] = &[0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x09, 0x0E];

    // All DPE certs are valid from January 1st, 2023 00:00:00 until
    // December 31st, 9999 23:59:59
    const NOT_BEFORE: &'static str = "20230227000000Z";
    const NOT_AFTER: &'static str = "99991231235959Z";
